...
public interface NotificationOutboxRepository
  ...
  List<NotificationOutboxEntity> findByStatusAndNextAttemptAtLessThanEqualOrderByCreatedAtAsc(
      String status, Instant now, Pageable pageable);

  @Modifying
  @Transactional
  @Query("update NotificationOutboxEntity e set e.status = 'PROCESSING', e.lockedAt = :now, "
  ...
  @Modifying
  @Transactional
  @Query("update NotificationOutboxEntity e set e.status = 'PENDING', e.lockedAt = null, "
  ...
  @Modifying
  @Transactional
  @Query("delete from NotificationOutboxEntity e where e.status = 'PUBLISHED' "
      + "and e.publishedAt < :cutoff")
  int deletePublishedBefore(@Param("cutoff") Instant cutoff);

  @Modifying
  @Transactional
  @Query("delete from NotificationOutboxEntity e where e.status = 'DEAD' "
